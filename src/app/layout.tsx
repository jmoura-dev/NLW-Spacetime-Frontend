...
export const metadata = {
  title: 'NLW Spacetime',
  description:
    'A time capsule built with React, Next.js, TaiwindCSS and Typescript.',
}
      ...
      >
        <main className="grid min-h-screen grid-cols-2">
          <div className="relative flex flex-col items-start justify-between overflow-hidden bg-[url(../assets/bg-stars.svg)] bg-cover px-28 py-16">
            ...
            <div className="absolute bottom-0 right-1 top-0 w-2 border-r border-white/10 bg-stripes pr-2"></div>
